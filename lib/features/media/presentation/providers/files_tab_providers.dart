...
/// The row's pointer to the file (`localPath` and, on iOS / macOS, a
/// security-scoped `bookmarkRef`) comes from [LocalFileHandleFactory],
/// which the import wizard's photo attachment shares so both paths store a
